...
@Component
public class BinanceFileLoaderServiceImpl extends FileLoaderService {
    ...
    @Autowired
    public BinanceFileLoaderServiceImpl(@Qualifier("DBBinanceExchangeDaoImpl") DBExchangeDao exchangeDao) {
        super(exchangeDao);
    }
