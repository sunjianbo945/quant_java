...
@Component("DBCoinbaseExchangeDaoImpl")
public class DBCoinbaseExchangeDaoImpl extends DBExchangeDao {
    @Autowired
    ...
    @Autowired
    public DBCoinbaseExchangeDaoImpl(@Qualifier("DefaultTimeConverter") TimeHelpers defaultTimeHelper,
    ...
    public long loadFile(String filePath){
        ...
        String sql = " COPY tbl_coinbase FROM  STDIN CSV HEADER NULL as 'NULL'";
    ...
    public int delete(long start,long end, String ticker, String pricingCurrency) {
        ...
        int ret =0;
        try {
            int exchangeId = ExchangeHelpers.getExchangeIdFromExchangeName(jdbcTemplate, DataServiceConstants.EXCHANGE_NAME_COIN_BASE);
            ...
            String sql = "set timezone = 'GMT' ; " +
                    "delete from tbl_coinbase where time_stamp " +
